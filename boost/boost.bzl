...
def boost_deps():
    ...
    if "boost" not in native.existing_rules():
        http_archive(
            ...
            urls = [
                "https://mirror.bazel.build/dl.bintray.com/boostorg/release/1.72.0/source/boost_1_72_0.tar.bz2",
                "http://dl.bintray.com/boostorg/release/1.72.0/source/boost_1_72_0.tar.bz2",
            ],
